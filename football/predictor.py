...
need_cols = ["season","seasonType","week","startDate","startTimeTBD","venue","venueId","homeTeam","awayTeam","homePoints","awayPoints","homeConference","awayConference","neutralSite"]
...
current_ratings, current_home_field = _fit_team_ratings(df)
